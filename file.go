...
// Modified for https://github.com/charlesportwoodii/coredns-partial`
package file
...
func (f File) ServeDNS(ctx context.Context, w dns.ResponseWriter, r *dns.Msg) (int, error) {
	...
	case NameError:
		...
		if f.Zones.Fallthrough[zone] {
			log.Infof("Forwarding request to upstream")
			return plugin.NextOrFailure(f.Name(), f.Next, ctx, w, r)
		}
	case Delegation:
